...
public class CellOccluder : MonoBehaviour {
    ...
    private CellOccluder hitOccluder;
    private bool hit;
    ...
    private void Start() {
        ...
        layerMask = (1 << LayerMask.NameToLayer("CellOccluders"));
    }
    ...
    public void RevealNeighbours() {
        ...
        foreach (MazeDirection direction in Enum.GetValues(typeof(MazeDirection))) {
            ...
            if (hit) {
                ...
                hitOccluder = hitInfo.transform.gameObject.GetComponent<CellOccluder>();
